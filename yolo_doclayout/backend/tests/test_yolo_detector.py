"""Unit tests for the YOLO Deep Learning Layout Detector."""
...
def test_yolo_detector_initialization():
    detector = LayoutDetector(confidence_threshold=0.50, device="cpu")
    assert detector.model is not None
    assert detector.confidence_threshold == 0.50


def test_yolo_detector_inference_on_synthetic_image():
    ...
    cv2.rectangle(image, (50, 40), (750, 360), (220, 240, 245), -1)  # Folio center
